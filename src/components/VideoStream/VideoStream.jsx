  ...
  return (
    <div className="video-stream-container">
      ...
      <div className="info-panel">
        ...
        <ul>
          <li>Метод: <strong>{useMjpeg ? 'MJPEG' : 'WebSocket'}</strong></li>
          <li>Сервер: <strong>localhost:8000</strong></li>
          <li>Статус: <span className={isConnected ? 'text-success' : 'text-error'}>
